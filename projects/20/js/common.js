...
$(document).ready(function () {
   ...
   if ($(window).width() < '600') {
      $('.product .item .button').text('Купить');
   }
   ...
   window.addEventListener("resize", function () {
      if (window.innerWidth < 600 && !$(".video-block__slider").hasClass("slick-initialized")) {
         $('.video-block__slider').slick({
            infinite: true,
            centerMode: true,
            slidesToShow: 1,
      ...
      } else if (window.innerWidth >= 600 && $(".video-block__slider").hasClass("slick-initialized")) {
         $('.video-block__slider').slick('unslick');
      }

   });

   $('.video-block .arrows .left').on('click', function () {
      $('.video-block__slider').slick('slickPrev');
   });
   $('.video-block .arrows .right').on('click', function () {
      $('.video-block__slider').slick('slickNext');
   });
